...
/**
 * Helps to perform API calls like POST, GET, PUT & DELETE and also builds Request Specifications
 */
public class RestAssuredUtils {

    /**
     * This method builds Request Specifications for the API Requests
     *
     * @param baseUrl - required for the method the url of the app to test
